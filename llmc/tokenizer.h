...
inline void tokenizer_init(Tokenizer *tokenizer, const char *filename) {
...
inline const char *tokenizer_decode(Tokenizer *tokenizer, uint32_t token_id) {
...
inline void tokenizer_free(Tokenizer *tokenizer) {
